package com.tufar.yemektarifleri
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if ( gelenBilgi.equals("menudengeldim")){
                // Yeni bir yemek eklemeye gelindi
                yemekIsmiText.setText("")
                yemekMalzemeText.setText("")
                button.visibility = View.VISIBLE    // herhangi bir görünümü görünmez veya görünür hale getirmek.

                val gorselSecmeArkaPlan = BitmapFactory.decodeResource(context?.resources,R.drawable.gorsel_seciniz)
    ...
    fun kaydet(view: View){
        ...
        if (secilenBitmap != null){
            ...
            kucukBitmap.compress(Bitmap.CompressFormat.PNG,50,outputStrem)
            val byteDizisi = outputStrem.toByteArray()
    ...
    fun kucukBitmapOlustur(kullaniciBitmapi: Bitmap, maxBoyut: Int) : Bitmap{
